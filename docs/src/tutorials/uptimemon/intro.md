...
In this tutorial, we'll create a performant and efficient monitoring service using Chronos. The service will regularly check URLs from a given list and notify you if any URL becomes unavailable.
...
The complete application (split into chapters to help you track the progress) is available in Chronos repository on GitHub in [docs/examples/uptimemon](https://github.com/status-im/nim-chronos/blob/master/docs/examples/uptimemon).
