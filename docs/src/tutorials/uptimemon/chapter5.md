...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:all}}
```

As usual, let's examine the changes part by part.

```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:ntfy_topic}}
```
...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:sendAlert}}
```
...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:headers}}
```
...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:body}}
```
...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:request}}
```

Create the request with the necessary properties. `meth` is the request's HTTP method.

```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:response}}
```
...
```nim
{{#shiftinclude auto:../../../examples/uptimemon/chapter5.nim:check}}
```
