...
**Source code:** [chapter3.nim](https://github.com/status-im/nim-chronos/blob/master/examples/http_server/chapter3.nim)
...
To test this version, run it with `nim r dashboard.nim` and use a tool like `curl` to send a POST request:
...
```nim
{{#shiftinclude auto:../../../../examples/http_server/chapter3.nim:handler_closure}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_server/chapter3.nim:reports_table}}
```
