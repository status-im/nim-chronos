...
**Source code:** [chapter8/src/uptimemon.nim](https://github.com/status-im/nim-chronos/blob/master/docs/examples/http_client/chapter8/src/uptimemon.nim)
...
```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:all}}
```

Let's see what changed.

```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:maxConcurrency}}
```

We define a constant that would determine the capacity of our semaphore.

```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:uris}}
```

We've added more URIs to the list to make batching effect visible.

```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:semaphore}}
```
...
```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:check}}
```

In the `check` function for a URI sequence, we create a semaphore of the required capacity.

```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:while_true}}
```
...
```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:pass_semaphore}}
```
...
```nim
{{#shiftinclude auto:../../../examples/http_client/chapter8/src/uptimemon.nim:sleep}}
```
