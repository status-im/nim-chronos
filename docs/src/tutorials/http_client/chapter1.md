...
**Source code:** [chapter1.nim](https://github.com/status-im/nim-chronos/blob/master/examples/http_client/chapter1.nim)

Copy and paste this code into `uptimemon.nim` (we'll go through each line in a moment):
