...
**Source code:** [chapter6.nim](https://github.com/status-im/nim-chronos/blob/master/examples/http_client/chapter6.nim)
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:ntfy_topic}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:sendAlert}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:headers}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:body}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:request}}
```

Create the request with the necessary properties. `meth` is the request's HTTP method.

```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter6.nim:response}}
```
