...
- [chapter5.nim](https://github.com/status-im/nim-chronos/blob/master/examples/http_client/chapter5.nim)
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:urls}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:findMarker}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:vars}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:findMarkerInSample}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:readMessage}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:let}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:url_response}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:except}}
```
...
```nim
{{#shiftinclude auto:../../../../examples/http_client/chapter5.nim:finally}}
```
