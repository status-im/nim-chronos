...
**Source code:** [chapter2.nim](https://github.com/status-im/nim-chronos/blob/master/examples/http_client/chapter2.nim)
...
Run this code with `nim r uptimemon.nim`. You'll see it checks each URI one by one, but much more efficiently than if it were creating a new session for each.
