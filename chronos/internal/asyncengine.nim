...
when defined(nimdoc):
  ...
  proc addSignal2*(
    ...
    hWait =
      registerWaitable(hEvent, flags, InfiniteDuration, continuation, udata).valueOr:
...
iterator trackerCounters*(loop: PDispatcher): tuple[name: string, value: TrackerCounter] =
