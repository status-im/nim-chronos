...
proc raiseHttpWriteError*(msg: string) {.noinline, noreturn, raises: [HttpWriteError].} =
...
func getTransferEncoding*(ch: openArray[string]): HttpResult[set[TransferEncodingFlags]] =
