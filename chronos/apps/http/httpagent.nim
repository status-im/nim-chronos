...
const
  ChronosName* = "nim-chronos" ## Project name string
  ChronosMajor* {.intdefine.}: int = 3 ## Major number of Chronos' version.
  ChronosMinor* {.intdefine.}: int = 0 ## Minor number of Chronos' version.
