.. title:: HTTP Server: Status Dashboard
.. importdoc:: ../http_client/intro

In this tutorial, we'll build a dashboard server for the [uptime monitor](../http_client/intro.html). This server will provide an API to receive status reports and a basic (since this is not a frontend tutorial) web interface to view the current status of monitored services.
