.. title:: Logging Requests with Middleware
...
.. include:: ../../../examples/http_server/chapter4/src/dashboard.nim
...
.. include:: ../../../examples/http_server/chapter4/src/dashboard.nim
   :start-after: #ANCHOR: middleware
   :end-before: #ANCHOR_END: middleware
   :code:
...
.. include:: ../../../examples/http_server/chapter4/src/dashboard.nim
   :start-after: #ANCHOR: setup_middleware
   :end-before: #ANCHOR_END: setup_middleware
   :code:

Then, include it in [new(typedesc[HttpServerRef], TransportAddress, HttpProcessCallback2, set[HttpServerFlags], set[ServerFlags], string, int, int, int, int, int, openArray[HttpServerMiddlewareRef])]:
