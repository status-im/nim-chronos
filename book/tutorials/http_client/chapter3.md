.. title:: Making Requests Concurrently
...
2. Await all `Future`s at once with [allFutures(varargs[Future[T]])].
...
.. include:: ../../../examples/http_client/chapter3/src/uptimemon.nim
...
.. include:: ../../../examples/http_client/chapter3/src/uptimemon.nim
   :start-after: #ANCHOR: check_uris
   :end-before: #ANCHOR_END: check_uris
   :code:
