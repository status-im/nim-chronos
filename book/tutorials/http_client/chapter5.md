.. title:: Smarter Health Check with Streaming
.. importdoc:: ../../api/chronos/apps/http/httpclient
.. importdoc:: ../../api/chronos/streams/asyncstream
.. importdoc:: ../../api/chronos/transports/stream
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: urls
   :end-before: #ANCHOR_END: urls
   :code:
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: findMarker
   :end-before: #ANCHOR_END: findMarker
   :code:
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: vars
   :end-before: #ANCHOR_END: vars
   :code:
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: findMarkerInSample
   :end-before: #ANCHOR_END: findMarkerInSample
   :code:
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: readMessage
   :end-before: #ANCHOR_END: readMessage
   :code:

[readMessage(AsyncStreamReader, ReadMessagePredicate)] calls `findMarkerInSample` repeatedly until either there's no more data to read or the exit flag is `true`. The value `found` tells us if the marker was found in any of the samples checked by `readMessage` and we simply return it.
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: let
   :end-before: #ANCHOR_END: let
   :code:
...
.. include:: ../../../examples/http_client/chapter5/src/uptimemon.nim
   :start-after: #ANCHOR: url_response
   :end-before: #ANCHOR_END: url_response
   :code:
