.. title:: Sending Alerts with POST Requests
...
.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
...
.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
   :start-after: #ANCHOR: ntfy_topic
   :end-before: #ANCHOR_END: ntfy_topic
   :code:

Define a new constant for the ntfy topic name you copied [Set Up ntfy]. Replace `YOUR_NTFY_TOPIC_NAME` with the actual value you copied from ntfy.

.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
   :start-after: #ANCHOR: sendAlert
   :end-before: #ANCHOR_END: sendAlert
   :code:
...
.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
   :start-after: #ANCHOR: headers
   :end-before: #ANCHOR_END: headers
   :code:
...
.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
   :start-after: #ANCHOR: body
   :end-before: #ANCHOR_END: body
   :code:

Requests body must be a sequence of bytes so we convert our text message using [stringToBytes(openArray[char])].

.. include:: ../../../examples/http_client/chapter6/src/uptimemon.nim
   :start-after: #ANCHOR: request
   :end-before: #ANCHOR_END: request
   :code:
...
.. image:: ../../img/ntfy_alerts_in_browser.png
   :alt: ntfy alerts in browser
