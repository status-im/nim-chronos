.. title:: Concepts
.. importdoc:: async_procs
.. importdoc:: api/chronos/config
...
Scheduling is done by calling [async procedures](./async_procs.html) that return
...
[config](./api/chronos/config.html) enabling stricter compile-time
...
[config](./api/chronos/config.html) module for more information.
